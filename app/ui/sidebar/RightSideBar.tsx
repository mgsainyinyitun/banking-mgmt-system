...
export default function RightSideBar() {
    ...
    return (
        <div className="flex h-[100%]">
            <div className={`overflow-hidden bg-content1-900 shadow-xl rounded-2xl text-primary-500 w-110 space-y-6 absolute inset-y-0 left-0 transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-200 ease-in-out lg:relative lg:translate-x-0 flex flex-col`}>
                ...
                <div className='h-full flex flex-col overflow-auto'>
                    ...
                    <div className='p-3 py-5 flex justify-center items-center flex-col gap-3'>
                        <h1 className="text-2xl font-bold text-center mt-5">Sai Nyi Nyi Tun</h1>
